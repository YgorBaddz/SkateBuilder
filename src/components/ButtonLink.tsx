  ...
  return (
    <PrismicNextLink
      className={clsx(
        ...
        size === "md" &&
          "gap-3 px-1 text-lg py-[clamp(0.625rem,2vw+0.25rem,0.75rem)]",
        size === "lg" &&
          "text-[clamp(1.125rem,1.5vw+0.5rem,1.25rem)] leading-[clamp(1.75rem,2vw+0.5rem,2.25rem)] gap-[clamp(0.75rem,2vw+0.25rem,1rem)] px-[clamp(0.25rem,1.5vw+0.1rem,0.5rem)] py-[clamp(0.75rem,2vw+0.25rem,1rem)]",
        color === "orange" &&
        ...
        <>
          <div
            className={clsx(
              ...
              size === "md" && "w-6 h-6",
              size === "lg" &&
                "w-[clamp(1.5rem,2vw+0.5rem,2rem)] h-[clamp(1.5rem,2vw+0.5rem,2rem)]"
            )}
          >
